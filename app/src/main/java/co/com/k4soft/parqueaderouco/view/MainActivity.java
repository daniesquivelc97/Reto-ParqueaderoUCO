...
import co.com.k4soft.parqueaderouco.view.reportemovimiento.ReporteMovimientoActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void goToReporteMovimientoActivity(View view) {
        Intent intent = new Intent(this, ReporteMovimientoActivity.class);
        startActivity(intent);
    }
}
